...
export default function HeroSection() {
  ...
  return (
    ...
    <section className="w-full flex justify-center ">
      <div className="relative max-w-[1600px] w-full transition-all duration-200 ease-in-out">
        {/* IMAGE */}
        <img
          src={images[current]}
          alt="hero"
        ...
        <button
          onClick={prevSlide}
          className="absolute left-1 top-1/3 -translate-y-1/2 text-black p-2 cursor-pointer outline-none 
          ">
          <ChevronLeft size={50} />
        </button>
